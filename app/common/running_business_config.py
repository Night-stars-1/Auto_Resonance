...
class RunningBusinessConfig(QConfig):
    ...
    夏尔 = ConfigItem("SkillLevel", "夏尔", 0, None)
    海因里希 = ConfigItem("SkillLevel", "海因里希", 0, None)
    苔妮 = ConfigItem("SkillLevel", "苔妮", 0, None)
    安菲娅 = ConfigItem("SkillLevel", "安菲娅", 0, None)
    静流·逐夏 = ConfigItem("SkillLevel", "静流·逐夏", 0, None)
    雅莱 = ConfigItem("SkillLevel", "雅莱", 0, None)
    伊索斯 = ConfigItem("SkillLevel", "伊索斯", 0, None)
    帕拉笛 = ConfigItem("SkillLevel", "帕拉笛", 0, None)
    佩罗塔 = ConfigItem("SkillLevel", "佩罗塔", 0, None)
